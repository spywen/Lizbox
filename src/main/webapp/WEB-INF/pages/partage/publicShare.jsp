...
<!-- <![endif]-->
<head>
    <title>Partage public - Lizbox</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row row-app">
                <div class="col-separator col-unscrollable box">
                    <div class="col-table">
                        <h4 class="innerAll margin-none border-bottom text-center"><i class="fa fa-download"></i> Fichier partagé</h4>
                        <div class="col-table-row">
                            <div class="col-app col-unscrollable">
                                <div class="col-app">
                                    <div class="login">
                                        <div class="placeholder text-center"><i class="fa fa-download"></i>
                                        </div>
                                        <div class="panel panel-default col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-4">
                                            <div class="panel-body">
                                                <h4>${publicSharePageObject.document.nom}.${publicSharePageObject.document.extension}</h4>
                                                <br/>
                                                <a href="${publicSharePageObject.downloadLink}" class="btn btn-default btn-block" target="_blank">Télécharger le fichier</a>
                                            </div>
                                        </div>
