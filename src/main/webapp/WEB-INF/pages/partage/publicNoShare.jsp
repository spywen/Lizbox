...
<!-- <![endif]-->
<head>
    <title>Erreur partage public - Lizbox</title>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row row-app">
                    <div class="col-separator col-unscrollable box">
                        <div class="col-table">
                            <h4 class="innerAll margin-none border-bottom text-center"><i class="fa fa-exclamation-circle"></i> Erreur de partage</h4>
                            <div class="col-table-row">
                                <div class="col-app col-unscrollable">
                                    <div class="col-app">
                                        <div class="login">
                                            <div class="placeholder text-center"><i class="fa fa-exclamation-circle"></i>
                                            </div>
                                            <div class="panel panel-default col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-4">
                                                <div class="panel-body">
                                                    <h4 class="text-error">Fichier non partagé ou inexistant.</h4>
                                                    <br/>
                                                    <button href="#" class="btn btn-default btn-block" target="_blank" disabled="disabled">Télécharger le fichier</button>
                                                </div>
                                            </div>
