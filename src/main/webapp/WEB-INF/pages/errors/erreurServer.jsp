...
<!-- <![endif]-->
<head>
    <title>Erreur serveur - Lizbox</title>
    <!-- Meta -->
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row row-app">
                    <div class="col-separator col-unscrollable box">
                        <div class="col-table">
                            <h4 class="innerAll margin-none border-bottom text-center"><i class="fa fa-times-circle"></i> Erreur Serveur :(</h4>
                                        ...
                                        <div class="login">
                                            ...
                                            <div class="panel panel-default col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-4">
                                                <div class="panel-body">
                                                    <h4>Une erreur est survenue. Si le problème persiste veuillez contacter l'administrateur.</h4>
                                                    <!--<strong>${exception.errCode}</strong><br/>
                                                    <em>${exception.errMsg}</em>-->
                                                </div>
                                            </div>
